...
dotnet tool run nukeeper repo $repositoryUrl "$github_token" --targetBranch "$targetBranch" --change $onVersionChange --consolidate --verbosity detailed --exclude $excludes
