...
namespace FlabIt.Guardians.Tests
{
    ...
    public class StringGuardiansExtensionLargerThanTest : StringGuardiansExtensionTestBase
    {
        ...
        #region PassThroughNonLargerThan
        ...
        [TestCaseSource(nameof(NullStringsTestValuesSource))]
        public void When_calling_PassThroughNonLargerThan_with_null_values_with_custom_message_exception_message_should_match(string testValue)
        {
            const int testLength = 0;

            AssertThatExceptionMessageShouldMatchCustomMessage<ArgumentNullException>(() => _ = StringGuardiansExtension.PassThroughNonLargerThan(testValue, testLength, message: TestCustomExceptionMessage));
        }
        ...
        #endregion PassThroughNonLargerThan
    }
}