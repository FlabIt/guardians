...
namespace FlabIt.Guardians.Tests.Exceptions
{
    ...
    public class ArgumentLengthLargerThanExceptionTest : ExceptionsTestBase
    {
        [Test]
        ...
        public void When_serializing_exception_with_message_and_innerException_should_deserialize_correctly()
        {
            ...
            var exception = new ArgumentLengthLargerThanException(message: TestExceptionMessage, innerException: testInnerException);
