...
namespace FlabIt.Guardians.Tests.Exceptions
{
    ...
    public class ArgumentLengthShorterThanExceptionTest : ExceptionsTestBase
    {
        ...
        {
            var exception = new ArgumentLengthShorterThanException();
        ...
        {
            var exception = new ArgumentLengthShorterThanException(TestExceptionMessage);
        ...
        {
            var exception = new ArgumentLengthShorterThanException(paramName: TestParameterName, message: TestExceptionMessage);
        ...
        public void When_serializing_exception_with_message_and_innerException_should_deserialize_correctly()
        {
            ...
            var exception = new ArgumentLengthShorterThanException(message: TestExceptionMessage, innerException: testInnerException);
        ...
        public void When_serializing_exception_with_paramName_and_message_and_innerException_should_deserialize_correctly()
        {
            ...
            var exception = new ArgumentLengthShorterThanException(paramName: TestParameterName, message: TestExceptionMessage, innerException: testInnerException);
