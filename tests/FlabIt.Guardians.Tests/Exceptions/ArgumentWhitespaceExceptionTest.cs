...
namespace FlabIt.Guardians.Tests.Exceptions
{
    ...
    public class ArgumentWhitespaceExceptionTest : ExceptionsTestBase
    {
        [Test]
        public void When_serializing_exception_with_default_values_should_deserialize_correctly()
        {
            var exception = new ArgumentWhitespaceException();
        ...
        {
            var exception = new ArgumentWhitespaceException(TestExceptionMessage);
        ...
        {
            var exception = new ArgumentWhitespaceException(paramName: TestParameterName, message: TestExceptionMessage);
        ...
        public void When_serializing_exception_with_message_and_innerException_should_deserialize_correctly()
        {
            ...
            var exception = new ArgumentWhitespaceException(message: TestExceptionMessage, innerException: testInnerException);
        ...
        public void When_serializing_exception_with_paramName_and_message_and_innerException_should_deserialize_correctly()
        {
            ...
            var exception = new ArgumentWhitespaceException(paramName: TestParameterName, message: TestExceptionMessage, innerException: testInnerException);
