...
namespace FlabIt.Guardians.Tests
{
    ...
    public class ReflectiveGuardiansExtensionNotOfTypeTest : ReflectiveGuardiansExtensionTestBase
    {
        ...
        public void When_calling_ThrowIfNotOfType_with_values_not_of_expected_type_exception_argumentName_and_message_should_match_default(object testValue)
        {
            ...
            AssertThatExceptionParamNameAndMessageShouldMatchDefaultArgumentName<ArgumentIsNotOfTypeException>(() => ReflectiveGuardiansExtension.ThrowIfNotOfType<string>(testValue), defaultMessage);
        }
        ...
        #region PassThroughNonNotOfType
        ...
        [TestCaseSource(nameof(NullOrNonStringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNotOfType_with_values_not_of_expected_type_exception_argumentName_and_message_should_match_default(object testValue)
        {
            var defaultMessage = string.Format(CultureInfo.InvariantCulture, FlabIt.Guardians.Properties.Resources.Exception_ArgumentOfTypeXIsNotOfTypeYMessageWithParamName, DefaultArgumentName, testValue?.GetType()?.FullName, typeof(string).FullName);

            AssertThatExceptionParamNameAndMessageShouldMatchDefaultArgumentName<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNotOfType<string>(testValue), defaultMessage);
        }

        [TestCaseSource(nameof(NullOrNonStringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNotOfType_with_values_not_of_expected_type_with_custom_argumentName_exception_argumentName_should_match(object testValue)
        {
            const string testValueParamName = nameof(testValue);

            AssertThatExceptionParamNameShouldMatchCustomArgumentName<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNotOfType<string>(testValue, testValueParamName), testValueParamName);
        }

        [TestCaseSource(nameof(NullOrNonStringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNotOfType_with_values_not_of_expected_type_with_custom_message_exception_message_should_match(object testValue)
        {
            AssertThatExceptionMessageShouldMatchCustomMessage<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNotOfType<string>(testValue, message: TestCustomExceptionMessage));
        }

        [TestCaseSource(nameof(NullOrNonStringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNotOfType_with_values_not_of_expected_type_with_custom_argumentName_and_custom_message_exception_properties_should_match(object testValue)
        {
            const string testValueParamName = nameof(testValue);

            AssertThatExceptionParamNameAndMessageShouldMatch<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNotOfType<string>(testValue, testValueParamName, TestCustomExceptionMessage), testValueParamName, TestCustomExceptionMessage);
        }
        ...
        [TestCaseSource(nameof(ObjectTypedTestValuesSource))]
        public void When_calling_PassThroughNonNotOfType_with_valid_values_for_desired_type_Object_should_not_throw(object testValue)
        {
            AssertThatReturnsInputAsOutput(() => ReflectiveGuardiansExtension.PassThroughNonNotOfType<object>(testValue), testValue);
        }
        ...
        [TestCaseSource(nameof(StringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNotOfType_with_valid_values_for_desired_type_String_should_not_throw(object testValue)
        {
            AssertThatReturnsInputAsOutput(() => ReflectiveGuardiansExtension.PassThroughNonNotOfType<string>(testValue), testValue);
        }

        [TestCaseSource(nameof(NullOrNonStringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNotOfType_with_invalid_values_for_desired_type_String_should_throw_ArgumentIsNotOfTypeException(object testValue)
        {
            AssertThatThrows<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNotOfType<string>(testValue));
        }
        ...
        [TestCaseSource(nameof(IEnumerableOfObjectTypedTestValuesSource))]
        public void When_calling_PassThroughNonNotOfType_with_valid_values_for_desired_type_IEnumerableOfObject_should_not_throw(object testValue)
        {
            AssertThatReturnsInputAsOutput(() => ReflectiveGuardiansExtension.PassThroughNonNotOfType<IEnumerable<object>>(testValue), testValue);
        }

        [TestCaseSource(nameof(NullOrNonIEnumerableOfObjectTypedTestValuesSource))]
        public void When_calling_PassThroughNonNotOfType_with_invalid_values_for_desired_type_IEnumerableOfObject_should_throw_ArgumentIsNotOfTypeException(object testValue)
        {
            AssertThatThrows<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNotOfType<IEnumerable<object>>(testValue));
        }

        #endregion Type IEnumerable<object>

        #endregion PassThroughNonNotOfType
    }
}