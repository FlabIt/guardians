...
namespace FlabIt.Guardians.Tests
{
    ...
    public class ReflectiveGuardiansExtensionNullOrNotOfTypeTest : ReflectiveGuardiansExtensionTestBase
    {
        ...
        public void When_calling_ThrowIfNullOrNotOfType_with_null_values_exception_argumentName_and_message_should_match_default(object testValue)
        {
            ...
            AssertThatExceptionParamNameAndMessageShouldMatchDefaultArgumentName<ArgumentNullException>(() => ReflectiveGuardiansExtension.ThrowIfNullOrNotOfType<object>(testValue), defaultMessage);
        }
        ...
        public void When_calling_ThrowIfNullOrNotOfType_with_values_not_of_expected_type_exception_argumentName_and_message_should_match_default(object testValue)
        {
            ...
            var defaultMessage = string.Format(CultureInfo.InvariantCulture, FlabIt.Guardians.Properties.Resources.Exception_ArgumentOfTypeXIsNotOfTypeYMessageWithParamName, DefaultArgumentName, testValue.GetType().FullName, typeof(string).FullName);

            AssertThatExceptionParamNameAndMessageShouldMatchDefaultArgumentName<ArgumentIsNotOfTypeException>(() => ReflectiveGuardiansExtension.ThrowIfNullOrNotOfType<string>(testValue), defaultMessage);
        }
        ...
        #region PassThroughNonNullNorNotOfType
        ...
        [TestCaseSource(nameof(NullValuesTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_null_values_exception_argumentName_and_message_should_match_default(object testValue)
        {
            var defaultMessage = string.Format(CultureInfo.InvariantCulture, FlabIt.Guardians.Properties.Resources.Exception_ArgumentNullMessageWithParamName, DefaultArgumentName);

            AssertThatExceptionParamNameAndMessageShouldMatchDefaultArgumentName<ArgumentNullException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<object>(testValue), defaultMessage);
        }

        [TestCaseSource(nameof(NullValuesTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_null_values_with_custom_argumentName_exception_argumentName_should_match(object testValue)
        {
            const string testValueParamName = nameof(testValue);

            AssertThatExceptionParamNameShouldMatchCustomArgumentName<ArgumentNullException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<object>(testValue, testValueParamName), testValueParamName);
        }

        [TestCaseSource(nameof(NullValuesTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_null_values_with_custom_message_exception_message_should_match(object testValue)
        {
            AssertThatExceptionMessageShouldMatchCustomMessage<ArgumentNullException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<object>(testValue, message: TestCustomExceptionMessage));
        }

        [TestCaseSource(nameof(NullValuesTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_null_values_with_custom_argumentName_and_custom_message_exception_properties_should_match(object testValue)
        {
            const string testValueParamName = nameof(testValue);

            AssertThatExceptionParamNameAndMessageShouldMatch<ArgumentNullException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<object>(testValue, testValueParamName, TestCustomExceptionMessage), testValueParamName, TestCustomExceptionMessage);
        }
        ...
        [TestCaseSource(nameof(NonStringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_values_not_of_expected_type_exception_argumentName_and_message_should_match_default(object testValue)
        {
            testValue.ThrowIfNull(nameof(testValue));

            var defaultMessage = string.Format(CultureInfo.InvariantCulture, FlabIt.Guardians.Properties.Resources.Exception_ArgumentOfTypeXIsNotOfTypeYMessageWithParamName, DefaultArgumentName, testValue.GetType().FullName, typeof(string).FullName);

            AssertThatExceptionParamNameAndMessageShouldMatchDefaultArgumentName<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<string>(testValue), defaultMessage);
        }

        [TestCaseSource(nameof(NonStringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_values_not_of_expected_type_with_custom_argumentName_exception_argumentName_should_match(object testValue)
        {
            const string testValueParamName = nameof(testValue);

            AssertThatExceptionParamNameShouldMatchCustomArgumentName<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<string>(testValue, testValueParamName), testValueParamName);
        }

        [TestCaseSource(nameof(NonStringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_values_not_of_expected_type_with_custom_message_exception_message_should_match(object testValue)
        {
            AssertThatExceptionMessageShouldMatchCustomMessage<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<string>(testValue, message: TestCustomExceptionMessage));
        }

        [TestCaseSource(nameof(NonStringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_values_not_of_expected_type_with_custom_argumentName_and_custom_message_exception_properties_should_match(object testValue)
        {
            const string testValueParamName = nameof(testValue);

            AssertThatExceptionParamNameAndMessageShouldMatch<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<string>(testValue, testValueParamName, TestCustomExceptionMessage), testValueParamName, TestCustomExceptionMessage);
        }
        ...
        [TestCaseSource(nameof(ObjectTypedTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_valid_values_for_desired_type_Object_should_not_throw(object testValue)
        {
            AssertThatReturnsInputAsOutput(() => ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<object>(testValue), testValue);
        }
        ...
        [TestCaseSource(nameof(StringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_valid_values_for_desired_type_String_should_not_throw(object testValue)
        {
            AssertThatReturnsInputAsOutput(() => ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<string>(testValue), testValue);
        }

        [TestCaseSource(nameof(NonStringTypedTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_invalid_values_for_desired_type_String_should_throw_ArgumentIsNotOfTypeException(object testValue)
        {
            AssertThatThrows<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<string>(testValue));
        }
        ...
        [TestCaseSource(nameof(IEnumerableOfObjectTypedTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_valid_values_for_desired_type_IEnumerableOfObject_should_not_throw(object testValue)
        {
            AssertThatReturnsInputAsOutput(() => ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<IEnumerable<object>>(testValue), testValue);
        }

        [TestCaseSource(nameof(NonIEnumerableOfObjectTypedTestValuesSource))]
        public void When_calling_PassThroughNonNullNorNotOfType_with_invalid_values_for_desired_type_IEnumerableOfObject_should_throw_ArgumentIsNotOfTypeException(object testValue)
        {
            AssertThatThrows<ArgumentIsNotOfTypeException>(() => _ = ReflectiveGuardiansExtension.PassThroughNonNullNorNotOfType<IEnumerable<object>>(testValue));
        }

        #endregion Type IEnumerable<object>

        #endregion PassThroughNonNullNorNotOfType
    }
}