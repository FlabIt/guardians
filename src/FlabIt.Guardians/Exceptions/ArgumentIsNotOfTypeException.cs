...
namespace FlabIt.Guardians.Exceptions
{
    ...
    public class ArgumentIsNotOfTypeException : ArgumentException
    {
        ...
        public ArgumentIsNotOfTypeException(string paramName, string message, [CanBeNull] string expectedFullyQualifiedType)
            : base(message, paramName)
        {
        ...
        /// <param name="innerException">The exception that is the cause of the current exception. If the innerException parameter is not a null reference, the current exception is raised in a catch block that handles the inner exception.</param>
        public ArgumentIsNotOfTypeException(string paramName, string message, [CanBeNull] string expectedTypeName, Exception innerException)
            : base(message, paramName, innerException)
        {
