...
{
    /// <summary>
    /// The exception that is thrown when a value that consists of only whitespace characters is passed to a method that does not accept it as a valid argument.
    /// </summary>
    ...
    public class ArgumentWhitespaceException : ArgumentException
    {
        ...
        protected ArgumentWhitespaceException(SerializationInfo serializationInfo, StreamingContext streamingContext)
